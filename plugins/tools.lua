--Begin Tools.lua :)
local SUDO = 269383514 -- put Your ID here! <===
...
1, nil, send_file, 'aLPHA', dl_cb, nil)
	end
	if matches[1]:lower() == "sendplug" and matches[2] then
	    local plug = "./plugins/"..matches[2]..".lua"
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 
1, nil, plug, 'aLPHA', dl_cb, nil)
    end
  end
...
_Sudoer And Admins aLPHA Bot Help :_
